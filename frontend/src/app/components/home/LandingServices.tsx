...
const services = [
  {
    ...
    description: "Multi-tenant cloud architecture, rapid turn-key SaaS MVP engineering, subscription billing, and secure database setups.",
  ...
  {
    title: "Enterprise AI Automations & Workflow Engineering",
    description: "Custom LLM integrations, autonomous AI agents, and intelligent workflow automation to maximize business efficiency.",
  ...
  {
    title: "Mobile & Web App Systems Architecture",
    description: "Cross-platform React Native mobile apps and ultra-fast Next.js web applications engineered for massive scale.",
  ...
  {
    title: "Next.js & React Native Development Team",
    description: "Dedicated full-stack software development teams ready to scale your technical infrastructure rapidly.",
    href: "/services/custom-software",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
  ...
  {
    title: "AI Automation Agency & Consulting",
    description: "Strategic technical consulting on where to build custom software, AI integration roadmaps, and architecture audits.",
    href: "/services/ai-automation",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    description: "Connecting enterprise systems with robust REST/GraphQL APIs, microservices, and serverless backends.",
    href: "/services/custom-software",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    ...
    <section className="py-24 relative overflow-hidden bg-slate-50 dark:bg-[#030014] transition-colors duration-500" id="services">
      ...
      <div 
        className={`absolute bottom-[-10%] right-[-10%] w-[50%] aspect-square rounded-full pointer-events-none transition-all duration-700 ${
          isDark ? 'bg-blue-500/10 blur-[100px]' : 'bg-blue-500/5 blur-[80px]'
        }`} 
      />
            ...
            return (
              <motion.div 
                ...
                className={`
                  ...
                  ${featured 
                    ? 'bg-gradient-to-br from-blue-600 to-indigo-700 border-blue-500 text-white shadow-[0_20px_50px_-10px_rgba(37,99,235,0.25)]' 
                    : isDark 
