...
export default function ServicesWhyUs() {
    ...
    return (
        <section className={`py-48 px-8 relative overflow-hidden transition-colors duration-500 ${isDark ? 'bg-[#030014]' : 'bg-white'}`}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                {reasons.map((reason, index) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h4 className={`text-lg font-black font-headline tracking-tighter mb-2 transition-colors group-hover:text-indigo-500 ${
                                                isDark ? 'text-white' : 'text-slate-900'
                                            }`}>
                                                {reason.title}
                                            </h4>
