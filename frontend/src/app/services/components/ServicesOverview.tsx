            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-24">
                    ...
                    >
                        ...
                        <span className={`text-[10px] font-black uppercase tracking-[0.3em] ${isDark ? 'text-indigo-400' : 'text-indigo-600'}`}>Capabilities</span>
                    </motion.div>
                        ...
                        <motion.div
                            ...
                            className={`group p-10 rounded-[2.5rem] border transition-all duration-500 hover:-translate-y-2 relative overflow-hidden ${
                                isDark 
                                    ...
                                    : 'bg-white border-slate-200 hover:border-indigo-500/40 shadow-xl shadow-slate-200/50'
                            }`}
                        >
                            ...
                            <h3 className={`text-2xl font-black font-headline tracking-tighter mb-4 transition-colors group-hover:text-indigo-500 ${
                            ...
                            <div className={`h-[1px] w-0 transition-all duration-700 group-hover:w-full ${
                                isDark ? 'bg-indigo-500/40' : 'bg-indigo-600'
                            }`} />
                        </motion.div>
                    ))}
                </div>
